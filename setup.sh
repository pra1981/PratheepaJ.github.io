...
rm -rf public
git add -u
git commit -m "Remove stable public folder"

msg "Adding the new \`master\` branch as a subtree"
git subtree add --prefix=public \
    git@github.com:PratheepaJ/PratheepaJ.github.io.git master --squash

msg "Pulling down the just committed file to help avoid merge conflicts"
git subtree pull --prefix=public \
    git@github.com:PratheepaJ/PratheepaJ.github.io.git master
