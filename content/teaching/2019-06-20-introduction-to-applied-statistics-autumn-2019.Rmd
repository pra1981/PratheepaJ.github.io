...
|**10/04/2019**|Week 2 [Lecture 6](Lecture_8_Diagnostics_for_SLR.pdf)|Diagnostics for simple linear regression|**CH**: Chapter 2.9|**Homework 2 posted**, **Homework 1 Due**|
...
|**10/11/2019**|Week 3 [Lecture 9](Lecture_13_Multiple_linear_regression_III.pdf), [Lecture 9](Lecture_15_Multiple_linear_regression_IV.pdf)|Multiple linear regression 3 (prediction, contrasts, testing) |**CH**: Chapter 3.10-3.11|**Homework 3 posted**, **Homework 2 Due**|
...
|**10/18/2019**|Week 4 [Lecture 12](Lecture_19_Interactions_and_qualitative_variables.pdf)|Interactions and qualitative variables (interactions)|**CH**: Chapter 5|**Homework 4 posted**, **Homework 3 Due**|
...
|**11/01/2019**|Week 6|Correlated errors [Lecture 18](Lecture_25_Correlated_Errors.pdf)|**CH**: Chapter 8,9|**Homework 5 posted**, **Homework 4 Due**|
...
|**11/08/2019**|Week 7 [Lecture 21](Lecture_27_Selection.pdf)|Selection|**CH**: Chapter 11|**Homework 6 posted**, **Homework 5 Due**|
|**11/11/2019**|Week 8 [Lecture 22]()|Selection|**CH**: Chapter 11|--|
|**11/13/2019**|Week 8 [Lecture 23]()|Selection|**CH**: Chapter 11|--|
|**11/15/2019**|Week 8 [Lecture 24](Lecture_28_Penalized_regression.pdf)|Penalized regression|**CH**: Chapter 10|**Homework 7 posted**, **Homework 6 Due**|
