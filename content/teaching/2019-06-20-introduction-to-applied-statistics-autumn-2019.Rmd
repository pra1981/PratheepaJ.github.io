...
|**09/27/2019**|Week 1 [Lecture 3](Lecture_3_tips_on_R.pdf)|Some tips on R|Lecture notes|**Homework 1 posted**|
...
|**10/07/2019**|Week 3|Multiple linear regression 1 (introduction, model, estimation, geometry of least squares)|**CH**: Chapter 3.1-3.5|--|
...
|**10/14/2019**|Week 4|Diagnostics in multiple linear regression (types of residuals, influence)|**CH**: Chapter 4|--|
|**10/16/2019**|Week 4|Diagnostics in multiple linear regression (outlier detection, residual plots)|**CH**: Chapter 4|--|
|**10/18/2019**|Week 4|Interactions and qualitative variables (interactions)|**CH**: Chapter 5|**Homework 4 posted**, **Homework 3 Due**|
|**10/21/2019**|Week 5|Interactions and qualitative variables (visualization, ANOVA)|**CH**: Chapter 5|--|
|**10/23/2019**|\rc Week 5 \bc |--|--|\rc Midterm Examinations \bc |
|**10/25/2019**|Week 5|ANOVA models (one-way ANOVA, testing, contrasts)|**CH**: Chapter 5|--|
|**10/28/2019**|Week 6|ANOVA models (two-way ANOVA, testing, contrasts, mixed effects model)|**CH**: Chapter 5|--|
|**10/30/2019**|Week 6|Transformations and Weighted Least Squares|**CH**: Chapter 6,7|--|
|**11/01/2019**|Week 6|Correlated errors|**CH**: Chapter 8,9|**Homework 5 posted**, **Homework 4 Due**|
|**11/04/2019**|Week 7|Correlated errors|**CH**: Chapter 8,9|--|
|**11/06/2019**|Week 7|Bootstrapping regression|Lecture notes will be provided|--|
|**11/08/2019**|Week 7|Selection|**CH**: Chapter 11|**Homework 6 posted**, **Homework 5 Due**|
|**11/11/2019**|Week 8|Selection|**CH**: Chapter 11|--|
|**11/13/2019**|Week 8|Selection|**CH**: Chapter 11|--|
|**11/15/2019**|Week 8|Penalized regression|**CH**: Chapter 10|**Homework 7 posted**, **Homework 6 Due**|
|**11/18/2019**|Week 9|Penalized regression|**CH**: Chapter 10|--|
|**11/20/2019**|Week 9|Penalized regression|**CH**: Chapter 10|--|
|**11/22/2019**|Week 9|Logistic regression|**CH**: Chapter 12|**Homework 7 Due**|
...
|**12/02/2019**|Week 10|Logistic regression|**CH**: Chapter 12|--|
|**12/04/2019**|Week 10|Poisson regression|**CH**: Chapter 13.3|--|
|**12/06/2019**|Week 10|Final Review|Review will be posted|--|
